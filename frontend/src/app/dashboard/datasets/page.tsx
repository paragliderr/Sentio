            ...
            <tbody>
              {datasets.map((ds) => (
                <tr key={ds.name} className="border-b border-border last:border-0 transition-colors hover:bg-secondary/30">
                  ...
                  <td className="px-5 py-4"><span className="font-mono text-xs text-muted-foreground">{ds.type}</span></td>
                  <td className="px-5 py-4"><span className="font-mono text-xs text-muted-foreground">{ds.records}</span></td>
                  <td className="px-5 py-4"><span className="font-mono text-xs text-muted-foreground">{ds.size}</span></td>
                  <td className="px-5 py-4">
